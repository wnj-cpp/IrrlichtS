...
namespace scene
{
	...
	*/
	class CSceneNodeAnimatorCameraPRG : public ISceneNodeAnimatorCameraRPG
	{
	public:
		//! Constructor
		CSceneNodeAnimatorCameraRPG(gui::ICursorControl* cursor, f32 rotateSpeed = -1500.0f,
	...
	private:
		...
		f32 MinRadian, MaxRadian; //最小最大弧度
		f32 MinRadius, MaxRadius; //最小最大距离
